    ...
    match tab_index {
        0 => (
            ...
            vec![
                ...
                fix(
                    "Shift the exact millisecond the bar turns BLUE to maximize straight-line speed.",
                ),
                Line::from(""),
                ...
                crit(
                    "If >115°C, engine damage is occurring. Power drops. Open radiator tape or check for body damage.",
                ),
                Line::from(""),
                warn("DELTA DISPLAY:"),
        ...
        1 => (
            ...
            vec![
                ...
                warn("LIVE TYRE DATA:"),
                t(
                    "Displays the current dynamic pressure and thermal load on the tyres in real-time.",
                ),
        ...
        2 => (
            ...
            vec![
                ...
                t(
                    "Rake is the difference between Rear and Front Ride Height. Higher rake = more front downforce.",
                ),
                ...
                fix(
                    "Delta > 15°C: Camber is too negative. Stand the tyre up (e.g. from -3.5 to -3.0).",
                ),
                fix(
                    "Delta < 5°C: Camber is too positive. Lay the tyre down for more cornering grip (-2.0 to -3.0).",
                ),
                Line::from(""),
                warn("BRAKE CAPACITY:"),
        ...
        4 => (
            ...
            vec![
                ...
                t(
                    "Look at the Throttle graph out of slow corners. If the line stair-steps, you lack mechanical grip.",
                ),
                fix("Soften Rear Spring rate or lower differential preload."),
                Line::from(""),
                warn("BRAKING EFFICIENCY:"),
                t(
                    "Look at the Brake graph slope. A vertical drop means lockup. A smooth release means good trail braking.",
                ),
                Line::from(""),
        ...
        5 => (
            ...
            vec![
                ...
                crit(
                    "OUT OF FUEL PREDICTION: Triggered when Estimated Laps > Laps Available in Tank.",
                ),
                fix(
                    "Lift and Coast: Lift throttle 50 meters earlier than normal and coast into braking zone.",
                ),
        ...
        6 => (
            ...
            vec![
                ...
                t(
                    "Clipping occurs when AC calculates a physics force (e.g. 15Nm) that exceeds your hardware limit.",
                ),
                t(
                    "The signal is truncated (clipped) at 100%, erasing all tyre slip and kerb details.",
                ),
                crit("RED GRAPH: You are driving blind through the steering wheel."),
                fix(
                    "Lower the 'Gain' slider in AC Control Settings until peaks barely touch Yellow.",
                ),
                Line::from(""),
                warn("INPUT TELEMETRY:"),
                t(
                    "G-Force Circle: Tracks lateral (cornering) vs longitudinal (braking/accel) loads.",
                ),
                t(
