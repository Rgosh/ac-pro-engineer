...
pub const CHAPTERS: [Chapter; 16] = [
    ...
    Chapter {
        ...
        lines: &[
            ...
            Line::Br,
            Line::Warn("STATUS: 'WAITING FOR THE SIMULATOR'"),
            Line::P("The application cannot read the game's telemetry pages."),
            Line::Br,
            Line::H2("THERE IS NOTHING TO SWITCH ON"),
            Line::P(
                "Both games publish their shared memory whenever they run. Content Manager has no 'Shared Memory' setting to tick — earlier versions of this guide said it had, and they were wrong.",
            ),
            Line::Br,
            Line::H2("WINDOWS"),
            Line::P(
                "Start the game and load a session; the pages are read directly. Check GAME: < ... > on the launcher names the game you are running.",
            ),
            Line::Br,
            ...
            Line::Br,
            Line::P(
                "Proof it is through: the game's telemetry pages appear under /dev/shm within a second of the bridge starting.",
            ),
        ],
    },
    Chapter {
