...
local RUSSIAN = {
  ...
  ['LAP'] = 'КРУГ',
  ['Debrief'] = 'Разбор',
  ['Show the lap time'] = 'Показывать время круга',
  ['Compare with the lap before'] = 'Сравнивать с предыдущим кругом',
  ['vs lap'] = 'к кругу',
  ['vs best'] = 'к лучшему',
  ['this is the best lap'] = 'это лучший круг',
  ['stint'] = 'отрезок',
  ['T:'] = 'Т:',
  ['B:'] = 'Торм:',
  ['Wear:'] = 'Износ:',
  ['Show stint length'] = 'Показывать длину отрезка',
  ['Compare with your best lap'] = 'Сравнивать с лучшим кругом',
  ['tyres'] = 'резина',
  ['fuel'] = 'топливо',
  ['laps left'] = 'кругов',
  ['Show sector times'] = 'Показывать секторы',
  ['Show what is left'] = 'Показывать остаток резины и топлива',
  ['Highlight a new lap'] = 'Подсвечивать новый круг',
  ['Scroll when it does not fit'] = 'Прокрутка, если не помещается',
  ['Inner / middle / outer'] = 'Внутр. / середина / внешн.',
  ['Colour the text by severity'] = 'Красить текст по важности',
  ['Jump to the newest lap'] = 'Переходить на свежий круг',
  ['CURRENT'] = 'ТЕКУЩИЙ',
  ['ENGINEER'] = 'ИНЖЕНЕР',
